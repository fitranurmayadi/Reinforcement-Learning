...
# mb4 = p.loadURDF("../urdf/chassi.urdf", flags=p.URDF_USE_IMPLICIT_CYLINDER, physicsClientId=org)
mb = p.loadURDF("../urdf/wheels.urdf", flags=p.URDF_USE_IMPLICIT_CYLINDER, physicsClientId=org)
...
while (p.getConnectionInfo(physicsClientId=gui)["isConnected"]):
  ...
  time.sleep(1)
  print(p.getBasePositionAndOrientation(mb,physicsClientId=gui))
#   [x,y,z,w]=p.getBasePositionAndOrientation(mb4,physicsClientId=gui)
